      ...
      >
        ...
        <div className="flex items-center justify-between gap-2">
          <div onClick={(e) => e.stopPropagation()}>
            <DropdownMenu>
              <DropdownMenuTrigger
                className={cn("inline-flex items-center gap-1.5 text-xs font-medium px-2 py-1 rounded-full cursor-pointer hover:opacity-80 transition-opacity", status.chip)}
              >
          ...
          <div className="flex items-center gap-1">
            <div onClick={(e) => e.stopPropagation()}>
              <DropdownMenu>
                <DropdownMenuTrigger
                  className={cn("text-xs px-2 py-0.5 rounded-full border font-medium cursor-pointer hover:opacity-80 transition-opacity inline-flex items-center gap-1", priority.className)}
                >
                  {priority.label}
                  <ChevronDown className="h-3 w-3 opacity-60" />
                </DropdownMenuTrigger>
